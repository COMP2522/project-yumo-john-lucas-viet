 ...
 * Extends the GameObj class and adds functionality for collision detection with
 * planes.
 *
 * @author Lucas Ying
 */
public class HealPowerUpsObj extends GameObj {
   ...
   */
  public HealPowerUpsObj(Image powerUpImg, int x, int y, int powerUpWidth, int powerUpHeight, int speed,
      GameWin gameWin) {
   ...
   * @return True if the power-up object collides with the other object, false
   *         otherwise
   */
  ...
  /**
   * Checks for collisions between this power-up object and planes, and handles
   * the collisions by removing the power-up object from the game.
   */
